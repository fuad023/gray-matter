  ...
  return (
    <>
      ...
      <div className="d-flex flex-column align-items-center justify-content-center">
        ...
        >
          <img src={Banner} alt="banner" style={{width: '800px', maxHeight: '400px'}}/>
          <div
        ...
        <div 
          className="border border-top-0 p-1 pt-2 d-flex align-items-center">
          <div
            className="d-flex flex-column ps-3"
            style={{ width: "800px"}}>
            <h3 className="fs-2">Sajid Al Amin</h3>
            <p className="fs-5">Student at Ahsanullah University of Science & Technology</p>
